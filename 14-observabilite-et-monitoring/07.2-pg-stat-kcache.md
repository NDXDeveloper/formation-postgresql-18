...
```bash
# ⚠️ pg_stat_kcache n'est PAS fournie par postgresql-contrib : c'est une extension
# tierce (powa-team), empaquetée séparément. Installer le paquet dédié (dépôt PGDG) :
