...
### 21. [PostgreSQL et Architectures Modernes](21-postgresql-et-architectures-modernes/README.md)
- 21.1 [Microservices et bases de données](21-postgresql-et-architectures-modernes/01-microservices-et-bdd.md)
    - 21.1.1 [Database per service vs Shared database](21-postgresql-et-architectures-modernes/01.1-database-per-service.md)
    - 21.1.2 [Distributed transactions et Saga pattern](21-postgresql-et-architectures-modernes/01.2-distributed-transactions-saga.md)
    - 21.1.3 [Foreign Data Wrappers pour la fédération](21-postgresql-et-architectures-modernes/01.3-fdw-federation.md)
- 21.2 [Event Sourcing et CQRS avec PostgreSQL](21-postgresql-et-architectures-modernes/02-event-sourcing-cqrs.md)
    - 21.2.1 [Event Store pattern](21-postgresql-et-architectures-modernes/02.1-event-store-pattern.md)
    - 21.2.2 [NOTIFY/LISTEN pour événements temps réel](21-postgresql-et-architectures-modernes/02.2-notify-listen.md)
    - 21.2.3 [Logical Decoding et Change Data Capture (CDC)](21-postgresql-et-architectures-modernes/02.3-logical-decoding-cdc.md)
    - 21.2.4 [Debezium pour streaming d'événements](21-postgresql-et-architectures-modernes/02.4-debezium.md)
- 21.3 [PostgreSQL en architecture serverless](21-postgresql-et-architectures-modernes/03-postgresql-serverless.md)
    - 21.3.1 [Neon, Supabase, PlanetScale alternatives](21-postgresql-et-architectures-modernes/03.1-neon-supabase-planetscale.md)
    - 21.3.2 [Connection pooling serverless (PgBouncer, RDS Proxy)](21-postgresql-et-architectures-modernes/03.2-connection-pooling-serverless.md)
    - 21.3.3 [Cold starts et gestion des connexions](21-postgresql-et-architectures-modernes/03.3-cold-starts-connexions.md)
- 21.4 [Intégration avec Kubernetes](21-postgresql-et-architectures-modernes/04-integration-kubernetes.md)
    - 21.4.1 [StatefulSets : Persistance et identité](21-postgresql-et-architectures-modernes/04.1-statefulsets.md)
    - 21.4.2 [Operators : Zalando, CloudNativePG, Crunchy](21-postgresql-et-architectures-modernes/04.2-operators.md)
    - 21.4.3 [Backup automation (Velero, native solutions)](21-postgresql-et-architectures-modernes/04.3-backup-automation.md)
    - 21.4.4 [Service mesh et observabilité](21-postgresql-et-architectures-modernes/04.4-service-mesh-observabilite.md)

### 22. [Conclusion et Perspectives](22-conclusion-et-perspectives/README.md)
- 22.1 [Résumé des concepts clés par niveau](22-conclusion-et-perspectives/01-resume-concepts-cles.md)
    - 22.1.1 [Débutant : SQL, DDL, DML, Contraintes](22-conclusion-et-perspectives/01.1-niveau-debutant.md)
    - 22.1.2 [Intermédiaire : Jointures, Agrégation, Indexation](22-conclusion-et-perspectives/01.2-niveau-intermediaire.md)
    - 22.1.3 [Avancé : MVCC, Réplication, Optimisation, Production](22-conclusion-et-perspectives/01.3-niveau-avance.md)
- 22.2 [L'avenir de PostgreSQL : Tendances et évolutions](22-conclusion-et-perspectives/02-avenir-de-postgresql.md)
    - 22.2.1 [Performances I/O et parallélisation](22-conclusion-et-perspectives/02.1-performances-io-parallelisation.md)
    - 22.2.2 [IA et Machine Learning intégrés](22-conclusion-et-perspectives/02.2-ia-machine-learning.md)
    - 22.2.3 [Cloud-native et distributed PostgreSQL](22-conclusion-et-perspectives/02.3-cloud-native-distributed.md)
    - 22.2.4 [Columnar storage (Hydra, pg_analytics)](22-conclusion-et-perspectives/02.4-columnar-storage.md)
- **22.3 [Les apports majeurs de PostgreSQL 18](22-conclusion-et-perspectives/03-apports-majeurs-pg18.md)** 🆕
    - 22.3.1 [I/O asynchrone (jusqu'à 3× plus rapide)](22-conclusion-et-perspectives/03.1-io-asynchrone.md)
    - 22.3.2 [UUIDv7 et colonnes virtuelles](22-conclusion-et-perspectives/03.2-uuidv7-colonnes-virtuelles.md)
    - 22.3.3 [OAuth et sécurité moderne](22-conclusion-et-perspectives/03.3-oauth-securite-moderne.md)
    - 22.3.4 [Upgrade simplifié avec préservation statistiques](22-conclusion-et-perspectives/03.4-upgrade-simplifie.md)
- 22.4 [Ressources pour aller plus loin](22-conclusion-et-perspectives/04-ressources-pour-aller-plus-loin.md)
    - 22.4.1 [Documentation officielle PostgreSQL](22-conclusion-et-perspectives/04.1-documentation-officielle.md)
    - 22.4.2 [Livres recommandés (PostgreSQL: Up and Running, Art of PostgreSQL)](22-conclusion-et-perspectives/04.2-livres-recommandes.md)
    - 22.4.3 [Communautés (pgsql-general, Reddit r/PostgreSQL, Discord)](22-conclusion-et-perspectives/04.3-communautes.md)
    - 22.4.4 [Conférences (PGConf, FOSDEM, PostgreSQL sessions)](22-conclusion-et-perspectives/04.4-conferences.md)
    - 22.4.5 [Blogs techniques (2ndQuadrant, Percona, CrunchyData)](22-conclusion-et-perspectives/04.5-blogs-techniques.md)
- 22.5 [Roadmap de montée en compétence](22-conclusion-et-perspectives/05-roadmap-montee-en-competence.md)
    - 22.5.1 [Parcours Développeur (0-6 mois, 6-12 mois, 12-24 mois)](22-conclusion-et-perspectives/05.1-parcours-developpeur.md)
    - 22.5.2 [Parcours DevOps/SRE](22-conclusion-et-perspectives/05.2-parcours-devops-sre.md)
    - 22.5.3 [Parcours DBA](22-conclusion-et-perspectives/05.3-parcours-dba.md)
    - 22.5.4 [Certifications PostgreSQL (EnterpriseDB, Percona)](22-conclusion-et-perspectives/05.4-certifications.md)
