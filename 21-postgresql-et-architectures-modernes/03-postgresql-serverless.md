...
| **Aurora Serverless v2** | Scaling automatique AWS (compute par ACU) |
| **Aurora DSQL** | AWS, GA mai 2025 : serverless distribué, scale-to-zero, multi-region actif/actif |
...
- **PlanetScale** : historiquement MySQL/Vitess, propose aussi du **PostgreSQL managé** depuis la GA de septembre 2025 (sharding horizontal Postgres "Neki" en cours de finalisation)

Vous apprendrez leurs forces, leurs différences et comment choisir.

### 21.3.2 — Connection Pooling Serverless (PgBouncer, RDS Proxy)
...
⏭️ [Neon, Supabase, PlanetScale alternatives](/21-postgresql-et-architectures-modernes/03.1-neon-supabase-planetscale.md)
