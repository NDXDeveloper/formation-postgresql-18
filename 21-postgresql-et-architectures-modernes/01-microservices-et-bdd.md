...
# 21.1 — Microservices et Bases de Données : Introduction
...
```
21.1 — Microservices et Bases de Données (cette introduction)
    │
    ├── 21.1.1 — Database per Service vs Shared Database
    │       │
...
⏭️ [Database per service vs Shared database](/21-postgresql-et-architectures-modernes/01.1-database-per-service.md)
