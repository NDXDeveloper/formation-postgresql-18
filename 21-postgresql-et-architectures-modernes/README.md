...
Ce chapitre explore les patterns et technologies qui dominent le développement logiciel contemporain. Des startups aux géants de la tech, ces approches permettent de construire des systèmes scalables, résilients et évolutifs.
...
Ce chapitre est divisé en **quatre grandes sections** complémentaires :
...
```
┌─────────────────────────────────────────────────────────────────────────┐
│                 Section 21.1 : Vue d'Ensemble                        │
├─────────────────────────────────────────────────────────────────────────┤
│                                                                         │
│  21.1.1  Database per Service vs Shared Database                     │
│             ─────────────────────────────────────────                   │
│             Choisir la bonne organisation des bases                     │
│             Avantages, inconvénients, compromis                         │
│                                                                         │
│  21.1.2  Distributed Transactions et Saga Pattern                    │
│             ─────────────────────────────────────────                   │
│             Maintenir la cohérence sans transactions globales           │
│             Orchestration vs Chorégraphie                               │
│                                                                         │
│  21.1.3  Foreign Data Wrappers pour la Fédération                    │
│             ─────────────────────────────────────────                   │
...
Adapter PostgreSQL au paradigme serverless :

```
┌─────────────────────────────────────────────────────────────────────────┐
│                 Section 21.3 : Vue d'Ensemble                        │
├─────────────────────────────────────────────────────────────────────────┤
│                                                                         │
│  21.3.1  Neon, Supabase, PlanetScale                                 │
│             ─────────────────────────────────────────                   │
│             Plateformes PostgreSQL serverless                           │
│             Branching, scale-to-zero, backend complet                   │
│                                                                         │
│  21.3.2  Connection Pooling Serverless                               │
│             ─────────────────────────────────────────                   │
│             PgBouncer et RDS Proxy                                      │
│             Modes session/transaction/statement                         │
│                                                                         │
│  21.3.3  Cold Starts et Gestion des Connexions                       │
│             ─────────────────────────────────────────                   │
│             Provisioned concurrency, warming, lazy loading              │
│             Patterns de réutilisation et résilience                     │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
Exploiter PostgreSQL en production sur Kubernetes :

```
┌─────────────────────────────────────────────────────────────────────────┐
│                 Section 21.4 : Vue d'Ensemble                        │
├─────────────────────────────────────────────────────────────────────────┤
│                                                                         │
│  21.4.1  StatefulSets : Persistance et Identité                      │
│             ─────────────────────────────────────────                   │
│             Pods ordonnés, PersistentVolumeClaims                       │
│             Services Headless, DNS stable                               │
│                                                                         │
│  21.4.2  Operators (Zalando, CloudNativePG, Crunchy)                 │
│             ─────────────────────────────────────────                   │
│             Comparaison des trois Operators majeurs                     │
│             Failover automatique, déploiement déclaratif                │
│                                                                         │
│  21.4.3  Backup Automation (Velero, Solutions Natives)               │
│             ─────────────────────────────────────────                   │
│             pgBackRest, Barman, WAL-G                                   │
│             Velero pour les ressources K8s, PITR                        │
│                                                                         │
│  21.4.4  Service Mesh et Observabilité                               │
│             ─────────────────────────────────────────                   │
│             Istio, Linkerd avec PostgreSQL                              │
│             Prometheus, Grafana, logs et traces                         │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
```
1. 21.1 — Microservices et Bases de Données
   │
   ├── 21.1.1 Database per Service vs Shared Database
   │              (comprendre les choix fondamentaux)
   │
   ├── 21.1.2 Distributed Transactions et Saga
   │              (gérer la cohérence)
   │
   └── 21.1.3 Foreign Data Wrappers
                  (fédérer les données)

2. 21.2 — Event Sourcing et CQRS
   │
   ├── 21.2.1 Event Store Pattern
   │              (fondations)
   │
   ├── 21.2.2 NOTIFY/LISTEN
   │              (temps réel simple)
   │
   ├── 21.2.3 Logical Decoding et CDC
   │              (capture avancée)
   │
   └── 21.2.4 Debezium
                  (production)

3. 21.3 — PostgreSQL en Architecture Serverless
   │
   ├── 21.3.1 Neon, Supabase, PlanetScale
...
4. 21.4 — Intégration avec Kubernetes
   │
   ├── 21.4.1 StatefulSets
   ...
   │              (automatisation)
   │
   ├── 21.4.3 Backup Automation
   │              (Velero, pgBackRest, Barman, WAL-G)
   │
   └── 21.4.4 Service Mesh et Observabilité
...
Ce chapitre vous emmène au-delà de PostgreSQL en tant que simple base de données. Vous allez découvrir comment PostgreSQL s'intègre dans les architectures logicielles modernes :
...
⏭️ [Microservices et bases de données](/21-postgresql-et-architectures-modernes/01-microservices-et-bdd.md)
