...
# 22.1 Résumé des Concepts Clés par Niveau
...
1. **Lisez d'abord le chapitre 22.1.1** entièrement  
...
2. **Concentrez-vous sur le chapitre 22.1.2**  
...
|----------|--------|-------------------|
| **22.1.1** | Débutant | SQL, DDL, DML, Contraintes |
| **22.1.2** | Intermédiaire | Jointures, Agrégation, Indexation |
| **22.1.3** | Avancé | MVCC, Réplication, Optimisation, Production |
...
⏭️ [Débutant : SQL, DDL, DML, Contraintes](/22-conclusion-et-perspectives/01.1-niveau-debutant.md)
