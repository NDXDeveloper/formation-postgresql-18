...
# 22.5.2 Parcours DevOps/SRE PostgreSQL
...
- **Azure Database for PostgreSQL** :
  - Flexible Server uniquement (Single Server retiré le 28 mars 2025)
...
⏭️ [Parcours DBA](/22-conclusion-et-perspectives/05.3-parcours-dba.md)
