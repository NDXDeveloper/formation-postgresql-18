...
# 22.3 Les Apports Majeurs de PostgreSQL 18
...
| Section | Contenu |
|---------|---------|
| **22.3.1** | I/O Asynchrone — Architecture, configuration, et gains de performance |
| **22.3.2** | UUIDv7 et Colonnes Virtuelles — Nouvelles fonctionnalités développeur |
| **22.3.3** | OAuth et Sécurité Moderne — Authentification et chiffrement |
| **22.3.4** | Upgrade Simplifié — Préservation des statistiques et options pg_upgrade |
...
⏭️ [I/O asynchrone (jusqu'à 3× plus rapide)](/22-conclusion-et-perspectives/03.1-io-asynchrone.md)
