...
| Unicité | Base de données | **Globale** |
| Prévisibilité | ❌ Prévisible | ✅ Imprévisible |
| Tri chronologique | ✅ Oui | ✅ Oui (v7) |
| Performance | Légèrement meilleur | Très bon (v7) |
| Réplication/Merge | ❌ Problématique | ✅ Facile |
| Sécurité | Exposition info | Aucune exposition |
...
-- ⚠️ IMPOSSIBLE de supprimer ou renommer une valeur !
