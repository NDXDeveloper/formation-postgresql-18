...
-- ⚠️ pid <> pg_backend_pid() : exclure la session psql qui exécute cette requête
--    (sinon on se suicide et l'erreur ne dit pas grand-chose).
-- ⚠️ datname = current_database() : limiter à la base courante.
