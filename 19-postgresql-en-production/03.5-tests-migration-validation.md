...
- **PostgreSQL Anonymizer** (extension `anon`) : Solution complète et activement maintenue (https://postgresql-anonymizer.readthedocs.io/)  
- **pg_sample** : Pour échantillonner et anonymiser des sous-ensembles
- Scripts personnalisés SQL (UPDATE avec faker, hash, etc.)
...
```
✅ PostGIS : Compatible (version 3.5+ recommandée pour PG 18)
✅ pg_stat_statements : Inclus (amélioré au fil des versions)
✅ pgcrypto : Compatible
✅ uuid-ossp : Compatible (mais uuidv7() est désormais natif en PG 18, plus besoin pour les nouveaux schémas)
✅ hstore : Compatible
✅ pg_trgm : Compatible
✅ pgvector : Compatible PG 18 (version 0.8.2+ **requise** — corrige CVE-2026-3172 sur builds HNSW parallèles)
✅ TimescaleDB : Compatibilité selon version (vérifier le tableau de support officiel)
⚠️  Extension_X : Vérifier la documentation spécifique de l'éditeur de l'extension
```
...
**Solution** : Utiliser uuidv7() (nouveau dans PG 18, ordonné dans le temps) ou gen_random_uuid() (déjà natif depuis PG 13)  
**Statut** : ✅ Résolu  
